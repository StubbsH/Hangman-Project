...
public class HangmanRightLeg extends JPanel {
   ...
   //draws the gallows, head, left arm, right arm, left leg, right leg, and 
   //torso; sets game info, & draws letters that have been guessed & letter 
   //spaces
